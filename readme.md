...
如下是程序在运行中收集的数据，以"total"结尾的字段表示对应月份的总金币，第一期签到为今200，而现在只有120了，这也就意味着，如果纯白嫖不氪金，签到是金币的唯一来源，需要差不多4个月才能买一张月卡，而这种非氪金途径获取的金币，过期时间是6个月，我们n站太大方啦！玩家有福了！

我倒要看看它会不会把收益再压缩，还有两个月的空间，好日子还在后头呢。
